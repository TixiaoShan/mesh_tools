...
```
sudo apt install -y libgsl-dev opencl-c-headers ocl-icd-opencl-dev

cd ~/Downloads
git clone https://github.com/uos/lvr2
cd lvr2
...
```
cd ~/catkin_ws/src
git clone https://github.com/TixiaoShan/mesh_tools.git
cd ~/catkin_ws/
